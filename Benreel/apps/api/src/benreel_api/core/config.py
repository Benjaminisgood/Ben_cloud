...
class Settings(BaseSettings):
    ...
    SESSION_COOKIE_NAME: str = "benreel_session"
    ...
    DATABASE_URL: str = f"sqlite:///{(_DATA_DIR / 'benreel.sqlite').resolve()}"
    VIDEO_LIBRARY_PATH: Path = Field(default=_DATA_DIR / "video_library.json")
    ...
    ALIYUN_OSS_ALLOWED_EXTENSIONS: str = ".mp4,.m4v,.mov,.webm"
