...
class Settings(BaseSettings):
    ...
    SESSION_COOKIE_NAME: str = "benprefs_session"
    ...
    DATABASE_URL: str = f"sqlite:///{(_DATA_DIR / 'benprefs.sqlite').resolve()}"
    SOURCE_DATABASE_PATH: Path = Field(default=_WORKSPACE_ROOT / "database" / "preferences.db")
