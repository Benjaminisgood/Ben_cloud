...
def _asset_version() -> str:
    ...
    tracked = [static_dir / "css" / "style.css", static_dir / "js" / "main.js"]
    mtimes = [int(p.stat().st_mtime) for p in tracked if p.exists()]
    return str(max(mtimes)) if mtimes else settings.APP_VERSION
