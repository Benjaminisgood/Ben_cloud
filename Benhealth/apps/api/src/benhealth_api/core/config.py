...
class Settings(BaseSettings):
    ...
    SESSION_COOKIE_NAME: str = "benhealth_session"
    ...
    DATABASE_URL: str = f"sqlite:///{(_DATA_DIR / 'benhealth.sqlite').resolve()}"
    SOURCE_DATABASE_PATH: Path = Field(default=_WORKSPACE_ROOT / "database" / "health.db")
