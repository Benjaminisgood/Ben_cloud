...
class Settings(BaseSettings):
    ...
    SESSION_COOKIE_NAME: str = "benvinyl_session"
    ...
    DATABASE_URL: str = f"sqlite:///{(_DATA_DIR / 'benvinyl.sqlite').resolve()}"
    DAILY_RECORD_COUNT: int = 4
    ...
    ALIYUN_OSS_ALLOWED_EXTENSIONS: str = ".mp3,.m4a,.aac,.wav,.flac,.ogg"
