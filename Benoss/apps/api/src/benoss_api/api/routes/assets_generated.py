"""Generated asset read endpoints."""
...
from ...repositories.assets_repo import get_generated_asset, list_ready_generated_assets
...
def get_asset_blob(
    ...
    return Response(content=data, media_type=asset.content_type or "application/octet-stream")
