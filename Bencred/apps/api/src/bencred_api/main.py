...
from bencred_api.db.session import engine
...
from bencred_api.web import router as web_router, STATIC_DIR
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Secure credential management for Ben_cloud",
        lifespan=lifespan,
    )
